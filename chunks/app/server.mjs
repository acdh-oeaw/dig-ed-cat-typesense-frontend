...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-c46174f0.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-a8da07b5.mjs').then((m) => m.default || m)
  },
  {
    name: "search",
    path: "/search",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/search-34041cd2.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-ff3a01a8.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-b0a5ccf8.mjs').then((r) => r.default || r));
