		...
		<div class="flex-col flex divide-y">
			...
			<div class="grid grid-cols-3 divide-x p-4">
				<div class="p-4">
					...
					the creation of a digital edition. This Catalogue provides an accessible record of
					standards and building technologies used, and thus an insight into past and present
					projects.
				</div>
				<div class="p-4">
